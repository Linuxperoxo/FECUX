...
int main(int argc, char **argv) {
  fecux::main::config *_config = static_cast<fecux::main::config *>(
      std::malloc(sizeof(fecux::main::config)));
  fecux::main::package *_package = static_cast<fecux::main::package *>(
      std::malloc(sizeof(fecux::main::package)));
